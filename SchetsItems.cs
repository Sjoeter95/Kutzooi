...
namespace SchetsEditor
{
    abstract class SchetsItem
    {
        ...
        public abstract string SchetsinTekst();
    }
    ...
    class TextItem : SchetsItem
    {
        ...
        public override string SchetsinTekst()
        {
            s = "TI" + "|" + startpunt.X.ToString() + ";" + startpunt.Y.ToString() + ":" +  c.ToString()  + "?" + f.ToString() + kwast.ToString() + "." ;
            return s;
    ...
    class RechthoekItem : TweepuntItem
    {
        ...
        public override string SchetsinTekst()
        {
            string s = "RI" + "|" + startpunt.X.ToString() + ";" + startpunt.Y.ToString() + ":" + eindpunt.X.ToString() + "." + eindpunt.Y.ToString() + "?" + kwast.ToString() + "." + gevuld.ToString() ;
            return s;
    ...
    public override string SchetsinTekst()
    {
        string s = "LI" + "|" + startpunt.X.ToString() + ";" + startpunt.Y.ToString() + ":" + eindpunt.X.ToString() + "." + eindpunt.Y.ToString() + "?" + kwast.ToString() + ".";
        return s;
